...
/* turso.executeMultiple(
  `
    ...
    ALTER TABLE user_orders ADD COLUMN tracking_url VARCHAR(250);
    ALTER TABLE user_orders ADD COLUMN courier_id VARCHAR(250);
    ALTER TABLE user_orders ADD COLUMN tracking_code VARCHAR(250);
    ALTER TABLE user_orders ADD COLUMN latest_webhook_event VARCHAR(250);

  ...
  const features = [
    {
      ...
      description: 'Our facilities are equipped with advanced systems for parcel security.',
      points: [
    ...
    },
    {
      ...
      description: 'Our team ensures the safe handling of your parcels with utmost care.',
      points: ['Rigorous training for safe handling', 'Attention to every detail', 'Safety prioritized at all stages'],
      imageUrl: '/assets/images/footer/secure-handling-protocols.png',
      reverse: true,
    },
    {
      title: 'Trusted Partnerships',
      description: 'We work with reputable partners to guarantee seamless deliveries',
      points: [
    ...
    },
    {
      ...
      description: 'We conduct regular inspections to ensure the secure transportation of parcels',
      points: [

...
import { IconTruckDelivery, IconHandClick, IconPackage, IconCertificate } from '@tabler/icons-react';
...
export default function CaringForCargo() {
  return (
    <div className="py-12 safe-area">
      {/* Heading */}
      <Title className="text-3xl font-bold !mb-3">Caring for Your Cargo, Every Step of the Way</Title>
      <Text color="dimmed" className="!mb-8">
        Create a free account. Start collecting better research data today — no credit card or contract required. Full

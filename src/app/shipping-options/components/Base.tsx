      ...
      <Grid align="start">
        ...
        <Grid.Col span={{ base: 12, md: 6 }} className="z-10">
          <Text size="md" className="text-gray-600 mb-6">
            At Cargosender.com, we recognize that every shipment has unique requirements. Our variety of shipping
            services ensures you find the perfect solution, whether you’re looking for affordability, flexibility, or
            speed. Take time to review the options and select the one that fits your needs best. If you have any
            questions, our team is always ready to assist.
          </Text>

...
import { Container, Paper, Title, Text, Group, Stack, Badge, Grid, ThemeIcon, List } from '@mantine/core'
...
export default function OrderConfirmation() {
  return (
    <Container size="lg" py="xl">
      ...
      {/* Order Details */}
      <Paper radius="md" p="xl" withBorder mb="xl">
        <Title order={3} mb="lg">Order Overview</Title>
        ...
        <Grid mb="xl">
          <Grid.Col span={6}>
            <Stack>
              ...
              <Group>
                <Badge variant="dot" color="blue">IN</Badge>
          ...
          <Grid.Col span={6}>
            <Stack>
              ...
              <Group>
                <Badge variant="dot" color="red">NP</Badge>
        ...
        <Grid>
          <Grid.Col span={4}>
            <Paper p="md" radius="md" withBorder>
              <Stack>
                <div style={{ height: 200, background: '#f1f3f5', borderRadius: 8 }}>
                  <IconPackage size={48} style={{ margin: '76px auto', display: 'block', opacity: 0.5 }} />
                </div>
                <Text fw={500}>How to best pack your package</Text>
                <Text c="dimmed" size="sm">Learn how to best pack your package</Text>
              </Stack>
            </Paper>
          </Grid.Col>
          ...
          <Grid.Col span={4}>
            <Paper p="md" radius="md" withBorder>
              <Stack>
                <div style={{ height: 200, background: '#f1f3f5', borderRadius: 8 }}>
                  <IconTruck size={48} style={{ margin: '76px auto', display: 'block', opacity: 0.5 }} />
                </div>
                <Text fw={500}>Packing for Pallets</Text>
                <Text c="dimmed" size="sm">Learn how to pack for pallet</Text>
              </Stack>
            </Paper>
          </Grid.Col>
          ...
          <Grid.Col span={4}>
            <Paper p="md" radius="md" withBorder>
              <Stack>
                ...
                <Text c="dimmed" size="sm">See all packing tips</Text>
              </Stack>
            </Paper>
          </Grid.Col>
        </Grid>

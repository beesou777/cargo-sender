  ...
  return (
    <>
      <article className="safe-area grid item-center justify-items-center py-14">
        <div className="w-full rounded-xl relative -top-24 flex flex-col gap-3 items-center bg-gray-200 p-8 pt-12">
          <Title order={3}>Business that have trusted bettersender</Title>
          <div className="w-full grid sm:flex gap-12 justify-around">

      ...
      <Grid align="start" gutter="lg">
        <Grid.Col className="align-start" span={{ base: 12, md: 5 }}>
          ...
          <Text color="dimmed" className="!mb-8">
            Delivering peace of mind with secure, reliable, and innovative solutions to protect your parcels at every
          ...
          <Grid align="center" justify="space-between" gutter="lg">
            {data.map((item, index) => (
              <Grid.Col key={index} span={{ base: 12, md: 6 }}>
                <Card padding="xl" radius="md" className="border border-gray-200 !bg-gray-100">
